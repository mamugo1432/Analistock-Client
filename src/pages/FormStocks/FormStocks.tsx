...
export default function FormStocks({ mode }: { mode: string }) {
  ...
  } = useForm<upsertStockBody>({ mode: "onTouched" });
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      disabled={mode == "delete"}
                      defaultValue={
                        mode == "edit" || mode == "delete" ? stock.ticket : ""
                      }
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      disabled={mode == "delete"}
                      defaultValue={
                        mode == "edit" || mode == "delete" ? stock.sector : ""
                      }
                      {...register("sector", {
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      disabled={mode == "delete"}
                      defaultValue={
                        mode == "edit" || mode == "delete" ? stock.peRatio : ""
                      }
                      step={0.0000000001}
                      {...register("peRatio", {
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      disabled={mode == "delete"}
                      defaultValue={
                        mode == "edit" || mode == "delete" ? stock.pbRatio : ""
                      }
                      step={0.0000000001}
                      {...register("pbRatio", {
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    {errors.netProfitMargin && (
                      <div className="invalid-feedback">
                        {errors.netProfitMargin.message}
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    {errors.dividendPayoutRatio && (
                      <div className="invalid-feedback">
                        {errors.dividendPayoutRatio.message}
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="col-12 col-sm-6 col-lg-5">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      disabled={mode == "delete"}
                      defaultValue={
                        mode == "edit" || mode == "delete" ? stock.date : ""
                      }
                      {...register("date", {
                        required: {
                          value: mode != "delete",
