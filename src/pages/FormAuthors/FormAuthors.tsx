...
export default function FormAuthors({ mode }: { mode: string }) {
  ...
  } = useForm<upsertAuthorsBody>({ mode: "onTouched" });
          ...
          <form action="" onSubmit={handleSubmit(submit)}>
            <div className="mb-3">
              ...
              <input
                ...
                defaultValue={
                  mode == "edit" || mode == "delete" ? author.fullName : ""
                }
                {...register("fullName", {
                  required: {
                    value: mode != "delete",
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                disabled={mode == "delete"}
                defaultValue={
                  mode == "edit" || mode == "delete" ? author.job : ""
                }
                {...register("job", {
                  required: {
                    value: mode != "delete",
                    message: "El puesto de trabajo es obligatorio",
                  },
                })}
              ></textarea>
