      ...
      <div className="card-body">
        ...
        <div className="consejo-footer">
          <div className="autor-info">
            ...
            <div className="autor-cargo"><i>{advice.jobAuthor}</i></div>
          </div>
          
          { isAuthenticated && user?.role=="ADMIN" &&
          <div className="botones-accion">
            <button  id="btn-edit-cardAdvice" className="btn btn-sm btn-warning" onClick={() => navigate("/advices/edit/"+advice.idAdvice)}>✏️</button>
            <button className="btn btn-sm btn-danger" onClick={() => navigate("/advices/delete/"+advice.idAdvice)}>🗑️</button>
          </div>
          }
        </div>
      </div>
